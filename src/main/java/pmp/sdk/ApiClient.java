...
public class ApiClient {
  ...
  private String basePath = "http://localhost:8000/api";
  ...
  /**
   *  TRB MOD
   *  Method to add an interceptor to fix the json output for GW
   */

    public void addInterceptor(String name, RequestInterceptor interceptor){
      addAuthorization(name, interceptor);
    }
